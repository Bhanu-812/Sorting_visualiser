...
l2 = [box(length=0.8, width=1, height=l[i], pos=vector(i - 50, 0, 0)) for i in range(len(l))]
...
def bubble():
    ...
    for i in range(len(l2)):
        ...
        l2[len(l2) - 1 - i].color = color.green
